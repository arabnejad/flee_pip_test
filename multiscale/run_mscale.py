...
if __name__ == "__main__":
    ...
    ig.ReadLocationsFromCSV(
        csv_name=os.path.join(data_dir, "locations-{}.csv".format(submodel_id))
    )

    ig.ReadLinksFromCSV(
        csv_name=os.path.join(data_dir, "routes-{}.csv".format(submodel_id))
    )

    ig.ReadClosuresFromCSV(
        csv_name=os.path.join(data_dir, "closures-{}.csv".format(submodel_id))
    )
    ...
    for l in coupled_locations:
        c.addCoupledLocation(location=lm[l], name=l)
