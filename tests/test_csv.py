...
def test_csv(end_time=50, last_physical_day=50):
    ...
    ig.ReadLocationsFromCSV(csv_name="test_data/test_input_csv/locations.csv")

    ig.ReadLinksFromCSV(csv_name="test_data/test_input_csv/routes.csv")

    ig.ReadClosuresFromCSV(csv_name="test_data/test_input_csv/closures.csv")
